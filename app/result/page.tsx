...
export default function ResultPage() {
  ...
  const modeMessage = useMemo(() => {
    if (mode === "hiragana") {
      return "히라가나 기초를 차근차근 다지는 중입니다.";
    }
    if (mode === "katakana") {
      return "가타카나 감각을 익히는 데 아주 좋은 흐름입니다.";
    }
    return "히라가나와 가타카나를 함께 복습하고 있습니다.";
  }, [mode]);
          ...
          <div className="mt-5 rounded-[28px] bg-white p-5 shadow-[0_14px_36px_rgba(15,23,42,0.07)] ring-1 ring-slate-100">
            ...
            <div className="mt-4 rounded-2xl bg-white p-4 ring-1 ring-slate-200">
              <div className="flex items-center justify-between">
                <span className="text-sm font-semibold text-slate-700">현재 오답 개수</span>
                <span className="text-lg font-bold text-slate-900">{wrongCount}개</span>
              </div>
